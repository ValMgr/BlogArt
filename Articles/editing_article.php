...
print_r($NumArt);
    ...
    $requete_edit = "UPDATE ARTICLE SET NumArt= ?,DtCreA=?,LibTitrA=?,LibChapoA=?,Parag1A=?,LibSsTitr1=?,Parag2A=?,
    LibSsTitr2=?,Parag3A=?,LibConclA=?,UrlPhotA=?,NumAngl=?,NumThem=?,NumLang=? WHERE NumArt = ?";
    $query = $dbPdo->prepare($requete_edit);
    ...
    $query->bindValue(15, $NumArt, PDO::PARAM_STR);
